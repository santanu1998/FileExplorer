...
//        String cardStorage = System.getenv("SECONDARY_STORAGE");
    ...
    public ArrayList<File> findFiles(File file) {
        ...
        if (files != null) {
            for (File sinjgleFile : files) {
                if (sinjgleFile.getName().toLowerCase().endsWith(".jpeg") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".jpg") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".png") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".mp3") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".wav") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".mp4") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".pdf") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".doc") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".mkv") ||
                        sinjgleFile.getName().toLowerCase().endsWith(".apk")) {
                    arrayList.add(sinjgleFile);
                }
            }
        }
        ...
        options.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            switch (selectedItem) {
                ...
                case "Delete":
                    ...
                    }).setNegativeButton("No", (dialogInterface, i15) -> optionDialog.cancel());
